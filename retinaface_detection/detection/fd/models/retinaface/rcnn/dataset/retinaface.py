...
class retinaface(IMDB):
    ...
    def gt_roidb(self):
        cache_file = os.path.join(
            self.cache_path, "{}_{}_gt_roidb.pkl".format(self.name, self._split)
        )
            ...
            for aline in self._fp_bbox_map[fp]:
                ...
                if self._split == "train":
                    ...
                    for li in range(5):
                        # print(landmark)
                        if (
                            landmark[li][0] == -1.0 and landmark[li][1] == -1.0
                        ):  # missing landmark
    ...
    def evaluate_detections(
        self, all_boxes, output_dir="./output/", method_name="insightdetection"
    ):
        pass
